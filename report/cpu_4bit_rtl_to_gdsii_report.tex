...
\begin{center}
  \includegraphics[width=0.88\textwidth,keepaspectratio]{annotated.png}

  \small\textit{Kết quả SDF annotation: toàn bộ path delay và timing check
  được annotate thành công.}
\end{center}
...
\begin{center}
  ...
  \small\textit{Kết quả testbench post-layout: mô phỏng hoàn tất với ACC
  bằng 6.}
\end{center}
...
\reportfigure{22.png}
{Waveform post-layout toàn bộ quá trình mô phỏng với các chân nguồn
VPWR/VGND và cùng chuỗi instruction như mô phỏng RTL.}
