...
\reportfigure[0.66\textwidth]{rtl_simulation_result.png}
...
\reportfigure[0.62\textwidth]{sta_after_pin_placement.png}
...
\reportpair{pin_placement_result.png}
{Bố trí các chân I/O}
{place_pin_result.png}
...
\reportfigure[0.82\textwidth]{pngen.png}
...
\reportpair{after_cts.png}
{Clock tree sau CTS}
{cts_result.png}
{Báo cáo timing sau CTS}
{Kết quả clock-tree synthesis.}

\reportpair{detail_placement_after_cts.png}
...
\reportfigure{filler_placement.png}
...
\reportfigure[0.62\textwidth]{routing_congestion.png}
{Bản đồ congestion sau global routing.}

\reportpair{detail_route.png}
{Layout sau detailed routing}
{detail_routing_result.png}
...
\reportfigure[0.92\textwidth]{post_detail_routing_checks.png}
{Kiểm tra sau detailed routing: antenna không có violation, VPWR/VGND
được kết nối và báo cáo DRC đã được tạo.}

\reportfigure[0.92\textwidth]{before_sign_off_corearea.png}
...
\reportpair{2026-07-27-155338_hyprshot.png}
{OpenRCX và SPEF}
{2026-07-27-155644_hyprshot.png}
{STA sau khi nạp ký sinh}
{Trích xuất ký sinh và post-route STA.}

\reportpair{2026-07-27-155615_hyprshot.png}
{Các đường setup sau khi nạp SPEF}
{2026-07-27-155513_hyprshot.png}
...
\reportfigure[0.88\textwidth]{gdsii_result.png}
...
\reportpair{gds_fixed_klayout_drc.png}
